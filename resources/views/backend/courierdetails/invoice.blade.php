...
<head>
    ...
    <!-- Site Title -->
    <link rel="icon" href="{{ asset('uploads/default_photo') }}" type="image/png" />
    <title>

          Invoice

      {{-- {{ env('APP_NAME') }} || Invoice - {{ $courier_summary->id }} --}}
    </title>
                ...
                <div class="tm_invoice_in">
                    <div class="tm_invoice_head tm_top_head tm_mb15 tm_align_center">
                        <div class="tm_invoice_left">
                            <div class="tm_logo"><img src="{{ asset('uploads/default_photo') }}" alt="Logo"></div>
                        </div>
                        <div class="tm_invoice_right tm_text_right tm_mobile_hide">
                            <div class="tm_f50 tm_text_uppercase tm_white_color">


                                Tracking Id - <b>{{$records->tracking_id}}</b>
                    ...
                    <div class="tm_invoice_info tm_mb25">
                        <div class="tm_card_note tm_mobile_hide"><b class="tm_primary_color">   Courier Status: </b> {{$records->status}}  </div>
                        <div class="tm_invoice_info_list tm_white_color">
                            <p class="tm_invoice_date tm_m0">Date: <b>  {{$records->created_at->format('D d,M-Y h:m:s A')}}   </b></p>
                        </div>
                    ...
                    <div class="tm_invoice_head tm_mb10">
                        ...
                        <p>
                            <strong class="text-inverse">Client Id:  {{$records->client_id}}  </strong><br>
                            <strong class="text-inverse">Branch:  {{$records->branch->branch_name}}  </strong><br>
                            <strong class="text-inverse">Name: {{$records->sender_name}}    </strong><br>
                            Address: {{$records->sender_address}}   <br>
                            Phone: {{$records->sender_phone}}  <br>
                        </p>
                        </div>
                        <div class="tm_invoice_right tm_text_right">
                        <p class="tm_mb2"><b class="tm_primary_color">To:</b></p>
                        <p>
                        <strong class="text-inverse">Branch:  {{$records->recbranch->branch_name}}  </strong><br>
                            <strong class="text-inverse">Name:  {{$records->receiver_name}}  </strong><br>
                            Address:  {{$records->receiver_address}}  <br>
                            Phone: {{$records->receiver_phone}} <br>
                        </p>
                        </div>
                    </div>
                    <div class="tm_table tm_style1">
                            ...
                            <div class="tm_table_responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="tm_width_4">{{ $records->item_description }}</td>
                                            <td class="tm_width_2">{{ $records->cost }}</td>
                                            <td class="tm_width_1">{{ $records->quantity }}</td>
                                            <td class="tm_width_2 tm_text_right">{{ $records->total_cost }}</td>
                                        </tr>
                        ...
                        <div class="tm_invoice_footer tm_border_top tm_mb15 tm_m0_md">
                            <div class="tm_left_footer">
                                ...
                                <p class="tm_m0">
                                {{ $records->payment_type }} <br>Status: {{ $records->payment_status }}  </p>
                            </div>
                                ...
                                <table class="tm_mb15">
                                    <tbody>
                                        <tr class="tm_accent_bg">
                                            ...
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right"> {{ $records->grand_total }}  </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="tm_note tm_text_center tm_font_style_normal">
                            ...
                            <p class="tm_m0">  {{ $records->comment }}     </p>
                            <hr class="tm_mb15">
                        </div><!-- .tm_note -->
